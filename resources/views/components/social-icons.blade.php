<div {{ $attributes->merge(['class' => 'flex items-center']) }}>
  <a
    href="https://www.facebook.com/abderrahmane.boukhezar?mibextid=ZbWKwL"
    target="_blank"
    class="
         w-10
         h-10
  ...
  <a
    href="https://twitter.com/abderrahmanecs"
    target="_blank"
    class="
       w-10
       h-10
  ...
  <a
    href="https://www.linkedin.com/in/abderrahmane-boukhezar-cs/"
    target="_blank"
    class="
       w-10
       h-10
